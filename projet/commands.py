...
def loadbd():
    ...
    user7 = User(mail="g@gmail.com", password=sha256("g".encode()).hexdigest(), num_tel="0871661865", nom="Macron", prenom="Emmanuel", role_id=1, ddn=datetime.strptime("1977-12-21", "%Y-%m-%d"),instrument_id=7)
    
    user8 = User(mail="aaa@gmail.com", password=sha256("aaa".encode()).hexdigest(), num_tel="0871661865", nom="Proche", prenom="Monsieur", role_id=4, ddn=datetime.strptime("1977-12-21", "%Y-%m-%d"))
    user9 = User(mail="bbb@gmail.com", password=sha256("bbb".encode()).hexdigest(), num_tel="0871661865", nom="Sy", prenom="Omar", role_id=4, ddn=datetime.strptime("1977-12-21", "%Y-%m-%d"))

    proche1 = Proche(id=1, musicien_mail ="a@gmail.com", proche_mail = "aaa@gmail.com")
    proche2 = Proche(id=2, musicien_mail ="a@gmail.com", proche_mail = "bbb@gmail.com")
    proche3 = Proche(id=3, musicien_mail ="c@gmail.com", proche_mail = "aaa@gmail.com")
    
    r1 = Repetition(id=1, lieu="Gymnase Mozart, 123 rue de la Musique", date=datetime.strptime("2024-03-10", "%Y-%m-%d"), accessoires=[e1,e2], description="repetition des percussions")
    r2 = Repetition(id=2, lieu="Gymnase Mozart, 123 rue de la Musique", date=datetime.strptime("2024-02-25", "%Y-%m-%d"), accessoires=[e1,e2,e4], description="repetition des instruments à vents")
    r3 = Repetition(id=3, lieu="18 rue des Cuivres", date=datetime.strptime("2024-03-05", "%Y-%m-%d"), accessoires=[e3,e5], description="repetition des violons et clarinette")
    r4 = Repetition(id=4, lieu="Gymnase Mozart, 123 rue de la Musique", date=datetime.strptime("2024-02-28", "%Y-%m-%d"), accessoires=[e1,e6], description="repetition orchestre")
    r5 = Repetition(id=5, lieu="10 boulevard Beethoven", date=datetime.strptime("2024-02-10", "%Y-%m-%d"), accessoires=[e1,e2,e3,e4,e5], description="repetition avant le concert de noel")


    a1 = Activite(id=1, nom="Concert de fevrier", lieu="salle des fêtes", date=datetime.strptime("28/02/2024", "%d/%m/%Y"), accessoires=[e1,e2,e3,e4,e5,e6], description="concert de noel avec tout l'orchestre")
    ...
    a3 = Activite(id=3, nom="Concert du nouvel an", lieu="gymnase sportif", date=datetime.strptime("01/01/2024", "%d/%m/%Y"), accessoires=[e6], description="concert de tambour, batterie, triangle")
    ...
    s1= Sondage(id=1, activite=a1, reponses_possibles=[re1,re2],date_fin=datetime.strptime("2024-02-24", "%Y-%m-%d"))
    s2= Sondage(id=2, activite=a2, reponses_possibles=[re1,re2],date_fin=datetime.strptime("2024-03-08", "%Y-%m-%d"))
    s3= Sondage(id=3, activite=a3, reponses_possibles=[re1,re2],date_fin=datetime.strptime("2023-12-20", "%Y-%m-%d"))
